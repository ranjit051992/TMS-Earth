...
class SalesforceTicketLogging {
    static async getHistoryRecordsFromDatabase() {
        ...
        const query = `SELECT Execution_Date, Pipeline_Instance, Product, Setup, Tenant, Scenario, Error, Issue FROM FailureAnalyzer_Npm_Gocd WHERE Product = "${process.env.PRODUCT}" AND Pipeline_Instance IN (${pipelineRange})`;
...
exports.SalesforceTicketLogging = SalesforceTicketLogging;
SalesforceTicketLogging.categoriesJsonFilePath = "allure-report/data/categories.json";
SalesforceTicketLogging.noOfDaysOfHistory = 5;
SalesforceTicketLogging.historyJsonArray = new Array();
SalesforceTicketLogging.historyFilePath = "./output/FailureHistory.json";
