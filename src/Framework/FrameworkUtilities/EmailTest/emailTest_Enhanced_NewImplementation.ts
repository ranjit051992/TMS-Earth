...
export class EmailTest_NewImpl {
    ...
    static async readEmail(email: string, password: string, parameter: string[], value: string[], InboxValue: string, delay: number) {
        return new Promise(async (resolve, reject) => {
            ...
            imap.once('ready', async function () {
                await EmailTest_NewImpl.openInbox(InboxValue, imap, async function (err: any, box: any) {
                    if (err) {
                                    ...
                                    f.on('message', async function (msg: any, seqno: any) {
                                        ...
                                        parser.on('data', async (data: any) => {
                                            ...
                                            await EmailTest_NewImpl.fetchmailBody(data).then(async function (email) {
                                                ...
                                                await EmailTest_NewImpl.getLinksFromBody(Startup.email_Test.get("emailBody")).then(async function () {
