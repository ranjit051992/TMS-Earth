...
/*    public static String				AttachmentFilePath													= commonPath + GlobalVariable.SETUP + "/Catalog_Item_File_Upload_xlsx.xlsx";
    public static String				imagePath															= commonPath + GlobalVariable.SETUP + "/ImageUpload.png";
...
//    public static String				TEXT_FILE_PATH														= commonPath + GlobalVariable.SETUP + "\\TextFile.txt";
   // public static String				PNG_FILE_PATH														= commonPath + GlobalVariable.SETUP + "\\PNGFile.png";*/
    ...
    public static String				BUYER_REVIEW_WARNING_MESSAGE										= "Switching to 'No' will reset suggested supplier(s).";
    ...
    public static String				ADHOC_APPROVER														= "Ad-hoc approver";
    ...
    public static String				LINE_ITEMS_DETAILS_TAB												= "Line Item Details";
    ...
    public static String				QUANTITY_AMOUNT_COLUMN												= "Quantity / Amount";
