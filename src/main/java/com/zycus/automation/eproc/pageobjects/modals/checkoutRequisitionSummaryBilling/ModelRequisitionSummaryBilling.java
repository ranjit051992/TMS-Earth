...
public class ModelRequisitionSummaryBilling
{
	...
	public static void clearBU(WebDriver driver, String testCaseName) throws ActionBotException
	{
		try
		{
			IModelRequisitionSummaryBilling reqSummary = FactoryModal.getInstanceOfIModelRequisitionSummaryBilling();
			reqSummary.clearBU(driver, testCaseName);
		}
		catch (FactoryMethodException e)
		{
			logger.error("Factory Method Exception in method clearBU " + e, e);
		}
	}
