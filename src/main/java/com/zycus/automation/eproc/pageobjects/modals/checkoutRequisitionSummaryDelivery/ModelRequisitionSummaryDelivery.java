...
public class ModelRequisitionSummaryDelivery
{
	...
	public static boolean isDeliveryMyAddressTab(WebDriver driver, String testCaseName) throws ActionBotException
	{
		...
		{
			IModelRequisitionSummaryDelivery reqSummary = FactoryModal.getInstanceOfIModelRequisitionSummaryDelivery();
			otherAddress = reqSummary.isDeliveryMyAddressTab(driver, testCaseName);
		}
		catch (FactoryMethodException e)
		{
			logger.error("Factory Method Exception in method isDeliveryMyAddressTab " + e, e);
		}
		return otherAddress;
	}
