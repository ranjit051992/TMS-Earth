...
public class IModelRequisitionSummaryDeliveryImpl implements IModelRequisitionSummaryDelivery
{
	static Logger logger = Logger.getLogger(IModelRequisitionSummaryDeliveryImpl.class);
	...
	{
		String deliverTo = ActionBot.fillAutoCompleteField(driver, DELIVERY_DELIVER_TO, deliveryDeliverTo);
		logger.info("Selected Deliver To : " + deliverTo);
		return deliverTo;
	}
	...
	{
		String deliveryAddress = ActionBot.fillAutoCompleteField(driver, DELIVERY_MY_ADDRESS, deliveryMyAddress);
		logger.info("Selected Delivery Address : " + deliveryAddress);
	...
	{
		String deliveryAddress = ActionBot.fillAutoCompleteField(driver, DELIVERY_MY_ADDRESS_CITY, newAddressCity);
		logger.info("Selected New Delivery Address City : " + deliveryAddress);
		return deliveryAddress;
	}
	...
	public String fillDeliveryOtherAddress(WebDriver driver, String testCaseName, String deliveryOtherAddress) throws ActionBotException
	{
		...
		return ActionBot.fillAutoCompleteField(driver, DELIVERY_OTHER_ADDRESS, deliveryOtherAddress);
		 ...
		 */
		/*
		 * if (deliveryOtherAddress != null)
		 * {
		 * return deliveryOtherAddress;
		 * }
		 * else
		 * {
		 * return null;
	...
	public boolean selectDeliveryMyAddress(WebDriver driver, String testCaseName) throws ActionBotException
	{
		...
		//ActionBot.click(driver, By.xpath(".//*[@id='customAddress_headerCustomAddress']//input[@container='myAddressOption']"));
	...
	public boolean selectDeliveryOtherAddress(WebDriver driver, String testCaseName) throws ActionBotException
	{
		...
		if (ActionBot.findElement(driver, DELIVERY_OTHER_ADDRESS_SELECTED).isSelected())
		{
			return true;
		}
		else
	...
	/*
	 * check delivery my address tab present
	 */
	@Override
