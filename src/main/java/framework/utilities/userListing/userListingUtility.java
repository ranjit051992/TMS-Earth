package framework.utilities.userListing;
...
public class userListingUtility
{

	public static Logger logger = Logger.getLogger(userListingUtility.class);
	...
	public static User beforeLogin(WebDriver driver, TestReportingBO testcase) throws Exception
	{
		...
		try
		{
			...
			user = userListingUtility.reserveUser(driver, testcase);
		}
		catch (Exception e)
		{
			throw e;
	...
	public static User reserveUser(WebDriver driver, TestReportingBO testcase) throws Exception
	{
		...
		try
		{
			...
			user = userListingUtility.setUserInActive(driver, testcase);
	...
	public static void releaseUser(WebDriver driver, TestReportingBO testcase, User user) throws Exception
	{
		try
		{
			if (user != null)
			{
				...
				{
					userListingUtility.setUserActive(user);
