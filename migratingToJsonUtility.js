...
const setupObjects = {
    "setups": [
        {
            "branchName": "partner_JSON_Impl_Copy",
            "tableName": "eProc_PARTNER_UI_Elements",
            "productName": "eProc"
           
        },
        {
            "branchName":"staging_AutoHeal",
            "tableName":"eProc_USSTAGING_UI_Elements",   
            "productName": "eProc"        
        }
    ]
};
...
async function migrateLMTDetailsToJson() {
    ...
    for (const [key, value] of LMTMap) {
        jsonObject[key] = value.get("MST_key");
    }
