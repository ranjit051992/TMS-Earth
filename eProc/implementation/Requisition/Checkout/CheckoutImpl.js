 ...
 /** 
    ...
    */
    ...
    async fillBuyerInTextBox(buyerName)
    {
        ...
        await commonComponent.searchAndSelectFromDropdown(I.getElement(iCheckout.BUYER_TEXTBOX),buyerName, optionXpath);
    ...
    async fillItemDetails(requisitionBO)
    {
        ...
        if(requisitionBO.buyer !== "undefined")
        {
            ...
            await this.selectBuyerDropDownOption(requisitionBO.buyerOption);
    ...
    {
        this.clickOnTab(lmtVar.getLabel("CHECKOUT_TAXES_TAB"));

        this.clickOnRemoveAllTaxesButton();

        if(requisitionBO.taxType !== "undefined")
        {
            let taxType = this.fillTaxType(requisitionBO.taxType);
            requisitionBO.setTaxType(taxType);
        }

        if(requisitionBO.taxName !== "undefined")
        {
            let taxName = this.fillTaxName(requisitionBO.taxName);
