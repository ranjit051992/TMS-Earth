...
When("I add 1 catalog item", async function() {
   ...
   await spoImpl.clickonTab(global.uiElements.get(iSpoObject.TAB_NAME_LIST), iConstants.SPO_LINE_ITEMS_SECTION);
...
Then("Item should be added", async function() {
   ...
   await I.seeElement(global.uiElements.get(iSpoObject.PO_VIEW_BASIC_DETAILS_SECTION));
   await spoImpl.clickonTab(global.uiElements.get(iSpoObject.TAB_NAME_LIST), iConstants.SPO_VIEW_LINE_ITEMS_SECTION);
