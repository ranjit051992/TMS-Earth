...
When("I create a requisition to PO with {int} {string} item", async function(noOfItems, itemType) {
...
When("I search for the reqToPO", async function(){
    const number = this.reqBO.poNumber;
    await receiptImpl.searchPONumber(number);
});
